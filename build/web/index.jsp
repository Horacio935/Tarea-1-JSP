...
#boton{
    ...
    <body style="background-color:#D7FFBB">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form action="sr_estudiante" method="post" class="form-group">
            ...
            <button style="background-color:#73F519" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal_empleado" onclick="limpiar()">Nuevo Registro</button>
        </div>
